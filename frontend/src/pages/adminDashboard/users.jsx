                        ...
                        <div className="mt-4 w-full flex flex-col gap-2">
                            <div className="flex items-center gap-2 w-full">
                                ...
                                <button
                                    ...
                                    className="inline-flex w-auto rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700"
                                >
                            ...
                            {showAdvanced && (
                                <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-3">
                                    ...
                                    <div>
                                        <label className="block text-xs text-slate-500">Created From</label>
                                        <input
                                            type="date"
                                            value={dateFrom}
                                    ...
                                    <div>
                                        <label className="block text-xs text-slate-500">Created To</label>
                                        <input
                                            type="date"
                                            value={dateTo}
                                    ...
                                    <div className="sm:col-span-3">
                                        <div className="flex gap-2 mt-2">
                                            <button
                                                type="button"
                                                onClick={() => { setFilterRole('all'); setDateFrom(''); setDateTo(''); }}
                                                    ...
                                                    <td className="px-4 py-3">
                                                        <div className="flex items-center gap-2">
                                                            <button
                                                                ...
                                                                className="inline-flex w-auto rounded-md border border-slate-300 px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-100"
                                                            >
                                                                Edit
                                                            </button>
                                                            <button
                                                                ...
                                                                className="inline-flex w-auto rounded-md border border-red-300 px-3 py-1.5 text-xs font-medium text-red-700 hover:bg-red-50"
                                                            >
                        ...
                        <form className="mt-4 space-y-4" onSubmit={handleEditSubmit}>
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                <button
                                    ...
                                    className="inline-flex w-auto rounded-md border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700"
                                >
                                    Cancel
                                </button>
                                <button
